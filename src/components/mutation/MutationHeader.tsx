  ...
  return (
    <div className="p-4 border-b border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800">
      ...
      <div className="flex items-start justify-between gap-4 mb-3">
        ...
        <div className="flex-1">
          ...
          <div className="text-sm font-mono bg-gray-50 dark:bg-gray-700 p-2 rounded border dark:border-gray-600 text-gray-800 dark:text-gray-200">
            {selectedMutation.mutationKey ||
              `Mutation #${selectedMutation.mutationId}`}
          </div>
        </div>
        ...
        <div className="flex-shrink-0">
          ...
          <div
            className={`px-3 py-1 rounded text-white text-sm font-medium ${status.bgColor}`}
          >
            {status.text}
          </div>
        </div>
      ...
      <div className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
        ...
        <div>
          Submitted: {new Date(selectedMutation.submittedAt).toLocaleString()}
        </div>
